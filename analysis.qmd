...
#| echo: false
#| eval: false
hex_2SFCA_2025 = read_rds("data/rds/analysis/aac/hex_2SFCA_2025.rds")
```
...
#| echo: false
#| eval: false
hex_KD2SFCA_network = read_rds("data/rds/analysis/aac/hex_KD2SFCA_network.rds")
```
...
tm_shape(mpsz,
  ...
  tm_fill(col = "gray90",         
          border.col = "white",
          border.lwd = 0.5) +
  tm_text("SUBZONE_N", size = 0.4, col = "black") +
  tm_shape(hex_KD2SFCA_2025,
           bbox = map_ex) + 
  tm_fill(col = "aac_KD2SFCA_2025",
          n = 10,
  ...
  tm_symbols(size = 0.1,
             col = "pink") +
  tm_layout(main.title = "Accessibility of AAC: 2025",
            main.title.position = "center",
            main.title.size = 0.5,
            legend.outside = FALSE,
            legend.height = 0.25, 
...
tm_shape(mpsz,
  ...
  tm_symbols(size = 0.1,
             col = "pink") +
  tm_layout(main.title = "Accessibility of AAC: 2026",
            main.title.position = "center",
            main.title.size = 0.5,
            legend.outside = FALSE,
            legend.height = 0.25, 
...
tm_shape(mpsz,
  ...
  tm_symbols(size = 0.1,
             col = "pink") +
  tm_layout(main.title = "Accessibility of AAC: 2027",
            main.title.position = "center",
            main.title.size = 0.5,
            legend.outside = FALSE,
            legend.height = 0.25, 
...
tm_shape(mpsz,
  ...
  tm_symbols(size = 0.1,
             col = "pink") +
  tm_layout(main.title = "Accessibility of AAC: 2028",
            main.title.position = "center",
            main.title.size = 0.5,
            legend.outside = FALSE,
            legend.height = 0.25, 
...
tm_shape(mpsz,
  ...
  tm_symbols(size = 0.1,
             col = "pink") +
  tm_layout(main.title = "Accessibility of AAC: 2029",
            main.title.position = "center",
            main.title.size = 0.5,
            legend.outside = FALSE,
            legend.height = 0.25, 
