...
pacman::p_load(tidyverse, sf,
               ...
               leaflet, scales, lubridate, tmap, DT, geojsonsf)
```
:::
...
In this section, a total of 4 population datasets from year 2020 to year 2024 will be used in the analysis. The aim of this is to calculate the sruvival rate, in this instance, death is the outcome.
