...
### Combining MPSZ & Population Forecast - correct
...
#### Step 2: Calculate the Area of Each Subzone
...
#### Step 3: Intersect Hexagons with Subzones
...
# hex_res should be less than 97920

there is slightly increase as there are hex that have more than 2 SZ

```{r}
tmap_mode("plot")
tmap_options(check.and.fix = TRUE)
tm_shape(hex_mpsz_intersection) +
  tm_polygons()
```

#### Step 4: Calculate Area of Each Intersection
...
#LEFT JOIN hex_mpsz_intersection & mpsz_popforecast
...
#EDA plot estimated aged_pop vby hexagon for year 2025
