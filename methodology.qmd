...
The below code chunk joins the spatial intersection data with geriatric population forecasts by creating standardized join keys that handle inconsistencies in text formatting (case, whitespace) between the spatial and demographic datasets. This integration step combines spatial analysis infrastructure with demographic projections, creating the analytical foundation for accessibility research.
...
#| echo: false
#| eval: false
joined_data = read_rds("data/rds/mpsz/joined_data")
```
...
#| echo: false
#| eval: false
geriesti_hex_2025 = read_rds("data/rds/mpsz/geriesti_hex_2025")
geriesti_hex_2026 = read_rds("data/rds/mpsz/geriesti_hex_2026")
geriesti_hex_2027 = read_rds("data/rds/mpsz/geriesti_hex_2027")
geriesti_hex_2028 = read_rds("data/rds/mpsz/geriesti_hex_2028")
geriesti_hex_2029 = read_rds("data/rds/mpsz/geriesti_hex_2029")
```
